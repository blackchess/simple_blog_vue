...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/BlogPage', name: 'BlogPage', component: () => import(/* webpackChunkName: "BlogPage" */ '../components/BlogPage/BlogPage.vue'), meta: { title: '展示页面', keepAlive: false } },
			{ path: '/ArticleDetail', name: 'ArticleDetail', component: () => import('@/components/article/ArticleDetail.vue'), meta: { title: '详情页面', keepAlive: false } },
...
router.beforeEach((to, from, next) => {
  ...
  const path = ['/Admin','/Container','/ResourceImges','/Welcome','/Comment','/CommentReplay'];
